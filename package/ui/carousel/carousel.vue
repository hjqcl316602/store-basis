...
<template>
	<div class="vui-carousel" :class="className" @touchstart="eventStart" @touchmove="eventMove" @touchend="eventEnd"
	 @mousedown="eventStart" @mousemove="eventMove" @mouseup="eventEnd">
